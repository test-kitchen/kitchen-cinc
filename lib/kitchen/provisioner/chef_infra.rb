...
# with a non-CincInfra parent (i.e. omnibus-chef's gem loaded first), drop the
# binding before we redefine — otherwise Ruby raises TypeError on superclass
# mismatch. The two gems coordinate via this swap; see the kitchen-omnibus-chef
# factory in chef_infra.rb#new for the other side.
