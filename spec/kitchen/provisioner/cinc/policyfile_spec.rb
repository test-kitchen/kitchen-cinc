...
describe Kitchen::Provisioner::Cinc::Policyfile do
  let(:policyfile) { "" }
  let(:path) { "" }
  let(:null_logger) do
  ...
  let(:described_object) do
    Kitchen::Provisioner::Cinc::Policyfile.new(policyfile, path, logger: null_logger)
  end
  let(:os) { "" }
  before do
  ...
  describe "#resolve" do
    ...
    describe "on Unix with cinc-cli" do
      before do
        described_object.expects(:which).with("cinc-cli").returns("cinc-cli")
      end
      ...
      describe "with simple paths" do
        ...
        it do
          described_object.expects(:run_command).with("cinc-cli export /home/user/cookbook/Policyfile.rb /tmp/kitchen/cookbooks --force")
          subject
        end
      end
      ...
      describe "with Jenkins-y paths" do
        ...
        let(:path) { "/tmp/kitchen/cookbooks" }
        it do
          described_object.expects(:run_command).with("cinc-cli export /home/jenkins/My\\ Chef\\ Cookbook/workspace/current/Policyfile.rb /tmp/kitchen/cookbooks --force")
          subject
        end
      end
    end

    describe "on Unix with cinc" do
      before do
        described_object.expects(:which).with("cinc-cli").returns(false)
        described_object.expects(:which).with("cinc").returns("cinc")
      end
      ...
      describe "with simple paths" do
        ...
        let(:path) { "/tmp/kitchen/cookbooks" }
        it do
          described_object.expects(:run_command).with("cinc export /home/user/cookbook/Policyfile.rb /tmp/kitchen/cookbooks --force")
          subject
        end
      end
    end
    ...
    describe "on Unix with chef-cli" do
      before do
        described_object.expects(:which).with("cinc-cli").returns(false)
        described_object.expects(:which).with("cinc").returns(false)
    ...
    describe "on Windows with cinc-cli" do
      before do
        described_object.expects(:which).with("cinc-cli").returns("cinc-cli")
      end
      ...
      describe "with simple paths" do
        ...
        it do
          described_object.expects(:run_command).with('cinc-cli export C:\\cookbook\\Policyfile.rb C:\\Temp\\kitchen\\cookbooks --force')
          subject
        end
      end
      ...
      describe "with Jenkins-y paths" do
        ...
        let(:path) { 'C:\\Temp\\kitchen\\cookbooks' }
        it do
          described_object.expects(:run_command).with('cinc-cli export "C:\\\\Program\\ Files\\\\Jenkins\\\\My\\ Chef\\ Cookbook\\\\workspace\\\\current\\\\Policyfile.rb" C:\\Temp\\kitchen\\cookbooks --force')
          subject
        end
      end
    end
  ...
  describe "#compile" do
    ...
    describe "on Unix with cinc-cli" do
      ...
      describe "with simple paths" do
        let(:policyfile) { "/home/user/cookbook/Policyfile.rb" }
        it do
          described_object.expects(:run_command).with("cinc-cli install /home/user/cookbook/Policyfile.rb")
          subject
        end
      end
      ...
      describe "with Jenkins-y paths" do
        let(:policyfile) { "/home/jenkins/My Chef Cookbook/workspace/current/Policyfile.rb" }
        it do
          described_object.expects(:run_command).with('cinc-cli install /home/jenkins/My\\ Chef\\ Cookbook/workspace/current/Policyfile.rb')
          subject
        end
      end
    end
    ...
    describe "on Windows with cinc-cli" do
      ...
      describe "with simple paths" do
        let(:policyfile) { 'C:\\cookbook\\Policyfile.rb' }
        it do
          described_object.expects(:run_command).with('cinc-cli install C:\\cookbook\\Policyfile.rb')
          subject
        end
      end
      ...
      describe "with Jenkins-y paths" do
        let(:policyfile) { 'C:\\Program Files\\Jenkins\\My Chef Cookbook\\workspace\\current\\Policyfile.rb' }
        it do
          described_object.expects(:run_command).with('cinc-cli install "C:\\\\Program\\ Files\\\\Jenkins\\\\My\\ Chef\\ Cookbook\\\\workspace\\\\current\\\\Policyfile.rb"')
          subject
        end
      end
    end
